# -*- coding: utf-8 -*-
"""
Created on Sun Mar 14 19:17:15 2021
...
print(img_to_detect.shape)
plt.imshow(img_to_detect)

resized = cv2.resize(img_to_detect, (224, 224))
print(resized.shape)
plt.imshow(resized)

# convert to blob to pass into model
img_blob = cv2.dnn.blobFromImage(resized, 0.003922, (416, 416), swapRB=True, crop=False)
